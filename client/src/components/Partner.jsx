...
const Partner = () => {
  ...
  return (
    <>
      <div className="py-8 ">
      <h2 className="text-[1.80rem] lg:text[2.20rem] font-bold text-center  mb-4 text-gray-900">Our <span className=' text-orange-500 font-semibold font-sans'>Partners</span></h2>
