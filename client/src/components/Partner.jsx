  ...
  return (
    <>
      <div className="my-20">
        ...
        <div className="relative flex space-x-16 overflow-hidden rounded-lg my-6 bg-orange-50 group">
          ...
          {/* Scrolling content */}
          <div className='flex space-x-16 animate-loop-scroll h-24 my-6 group-hover:paused'>
