...
export default function TopCoursesCarousel() {
  ...
  return (
    <div className="w-full mb-10">
      <h2 className="text-[1.80rem] lg:text[2.20rem] font-bold text-center  mb-4 text-gray-900 ">Top <span className=' text-orange-500 font-semibold font-sans'>Courses</span></h2>
