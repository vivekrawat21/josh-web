...
import { FaBook, FaGift, FaSignOutAlt, FaVideo, FaBars, FaTimes, FaChalkboardTeacher, FaUser } from 'react-icons/fa';
import { MdPolicy } from 'react-icons/md';
import { BiSolidOffer, BiSolidInstitution } from 'react-icons/bi';
  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="hidden md:flex flex-col bg-white shadow-lg p-5 w-64 max-h-screen overflow-y-auto fixed top-0 left-0 z-40"
      >
        {navLinks.map((link) => (
        ...
        {isMobileMenuOpen && (
          ...
          >
            <motion.div
              ...
              className="fixed top-0 left-0 w-3/4 max-h-screen bg-white shadow-lg z-50 p-5 overflow-y-auto"
            >
