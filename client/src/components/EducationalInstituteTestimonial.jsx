...
const EducationalInstituteTestimonial = () => {
  ...
  return (
    <div className="w-full mx-auto px-4 py-16 bg-gradient-to-br from-orange-200 to-orange-50 rounded-2xl mb-10">
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="w-full lg:w-1/3 space-y-4">
          <span className="inline-block text-xs font-semibold text-orange-600 uppercase bg-orange-100 px-2 py-1 rounded-full">
            Success Story
          </span>
