...
const IntermediateBundle = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen mb-6 mx-4">
      {/* Header Section */}
      <header className="bg-gradient-to-r from-blue-900 to-blue-600 text-white p-4 flex justify-between items-center">
      ...
      {/* Hero Section */}
      <section className="bg-gradient-to-b from-blue-900 to-blue-600  text-white py-16 px-4">
        <div className="container mx-auto max-w-6xl">
          <Badge className="bg-[#F5DEB3] text-blue-800 mb-4">{bundle.bundleName}</Badge>
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Freelancing Road To 3 Lakhs Per Months</h1>
      ...
      <section className=" my-4 py-16 px-4 bg-gradient-to-b from-blue-900 to-blue-600 text-white">
      <div className="container mx-auto max-w-6xl">
        {/* Header */}
        <h2 className="text-2xl sm:text-3xl font-bold text-center mb-12">
          Master {bundle.bundleName} & Elevate Your Career!
          <span className="block w-32 sm:w-48 h-1 bg-green-800 mx-auto mt-2"></span>
        </h2>
  ...
  <div className="container mx-auto max-w-6xl">
    <h2 className="text-3xl font-bold text-center mb-12">
      ...
      <span className="block w-48 h-1 bg-blue-800 mx-auto mt-2"></span>
    </h2>

    <div className="bg-blue-100 rounded-lg p-6 sm:p-8 text-black relative overflow-hidden">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
      {bundle.courses?.map((course) => (
        ...
        >
          ...
          <div className="p-4 sm:p-6">
            <h3 className="text-lg sm:text-xl font-semibold mb-3 group-hover:text-blue-700 transition-colors">
              {course.title}
            </h3>
          </div>
        </div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
      <div>
        <h2 className="text-3xl font-bold mb-6">
          Before You Ask!
          <span className="block w-32 h-1 bg-blue-600 mt-2"></span>
        </h2>
        ...
        <div className="space-y-6">
          <div className="flex gap-4">
            <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-md bg-blue-600  flex items-center justify-center text-white flex-shrink-0">
              <CheckCircle className="h-5 w-5 sm:h-6 sm:w-6" />
            </div>
      ...
      <div className="flex items-center justify-center">
        <div className="border-4 border-blue-800 rounded-lg p-3 sm:p-4 bg-[#FFF8DC] max-w-xs sm:max-w-md">
          <img
            src="https://media.istockphoto.com/id/1128426035/vector/elegant-blue-and-gold-diploma-certificate-template.jpg?s=612x612&w=0&k=20&c=u6nl2YC0OfpYpcNS3C97EZhgaJKs4IVh-Tc0a55M-wc="
            alt="Certificate"
            className="rounded"
          />
        </div>
...
<section className= " bg-gradient-to-b from-blue-800  to-blue-500 text-white py-6 px-4">
