    ...
    return (
        ...
        <section className="relative pt-20 pb-20 md:pb-56 overflow-hidden">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center max-w-7xl mx-auto">
                ...
                <p className="text-xl text-white/100 leading-relaxed">
                    Discover untapped opportunities in digital marketing and learn how to leverage emerging trends to grow
                    your business.
                </p>
                ...
                <div className="relative">
                    ...
                    >
                        ...
                        <p className="text-sm font-medium text-gray-600">4.1/5 rating</p>
                        </div>
                    </motion.div>
                    </div>
                </div>
        ...
        <section id="about" className="py-5 md:py-10">
            ...
            >
                ...
                In this exclusive webinar, we'll explore emerging digital marketing opportunities that are reshaping the
                industry in 2025. Discover how to position your business to capitalize on these trends and stay ahead of
                the competition.
                </p>
            </motion.div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
                {[
                {
                    ...
                    description:
                    "Discover new digital channels and platforms that are gaining traction and offering untapped marketing potential.",
                },
                {
                    title: "AI-Driven Marketing",
                    description:
                    "Learn how artificial intelligence is transforming digital marketing and how to leverage it for better results.",
                },
                {
                    title: "Growth Strategies",
                    description: "Explore proven strategies to scale your digital marketing efforts and maximize ROI.",
                },
                ].map((feature, index) => (
                <motion.div
                    key={index}
        ...
        {/* Speakers Section */}
        <section id="speakers" className="py-10 bg-gradient-to-b from-white to-orange-50/50">
            <div className="container mx-auto px-4">
            <motion.div
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
            ...
            >
                ...
                Learn from industry leaders who have identified and capitalized on digital marketing opportunities.
                </p>
            </motion.div>
                ...
                >
                    ...
                    <div className="md:w-1/2 p-6 md:flex-col items-center justify-center">
                        <div className="hidden md:block">
                            ...
                            <p className="text-orange-300">{webinar.presenterRole}</p>
                        </div>
        ...
        <section id="agenda" className="py-10 bg-white">
            ...
            >
                ...
                <p className="text-lg text-gray-700 max-w-2xl mx-auto">
                A carefully crafted agenda to help you identify and capitalize on digital marketing opportunities.
                </p>
            </motion.div>
        ...
        <section id="register" className="py-10 bg-gradient-to-br from-orange-50 to-orange-100/50">
            <div className="container mx-auto px-4">
            <div className="max-w-5xl mx-auto">
                ...
                <div className="grid md:grid-cols-2">
                    ...
                    <p className="text-lg text-white/90 mb-8 leading-relaxed">
                        Don't miss this opportunity to discover untapped digital marketing opportunities. Registration is
        ...
        {/* CTA Section */}
        <section className="py-10 bg-gradient-to-r from-orange-600 to-orange-500 text-white">
            <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
                ...
                <h2 className="text-3xl md:text-4xl font-bold mb-6">
                    Ready to Discover New Digital Marketing Opportunities?
                </h2>
...
export default DigitalMarketingWebinar
