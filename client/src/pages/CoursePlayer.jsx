    ...
    <div className="flex flex-col md:flex-row w-full">
      ...
      <div className="w-full md:w-2/3 bg-white text-black shadow-lg">
        <div className="flex items-center justify-between p-4 border-b border-gray-300">
          <h1 className="text-base md:text-lg font-medium">{course.title}</h1>
        </div>
        ...
        <div className="p-4">
          {activeTab === "DISCUSSIONS" ? (
            <>
              <h3 className="text-lg md:text-2xl font-bold">Lesson Feedback</h3>
              <textarea
            ...
            <div className="mt-4">
              <h3 className="text-lg md:text-2xl font-bold mb-4">About This Course</h3>
