...
const MicrosoftDynamicsWebinar = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-purple-50/50 to-white">
      ...
      {/* Speakers Section */}
      <section id="speakers" className="py-20 bg-gradient-to-b from-white to-purple-50/50">
        <div className="container mx-auto px-4">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          <div className="flex justify-center">
              ...
              >
                <div className="bg-white rounded-2xl overflow-hidden shadow-xl shadow-purple-100/50 border border-purple-100/50 transition-all duration-300 group-hover:-translate-y-2">
      ...
      <section id="register" className="py-20 bg-gradient-to-br from-purple-50 to-purple-100/50">
        <div className="container mx-auto px-4">
