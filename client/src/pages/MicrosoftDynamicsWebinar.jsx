  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-purple-500 to-white">
      ...
      <section className="relative pt-24 pb-20 md:pb-56 overflow-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center max-w-7xl mx-auto">
            <motion.div variants={fadeIn} className="space-y-8">
              ...
              <p className="text-xl text-white/100 leading-relaxed">
                Master the powerful capabilities of Microsoft Dynamics 365 to transform your business operations and
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.98 }}>
                  <Button
                    size="lg"
                    className="bg-white text-purple-600 hover:bg-gray-100 rounded-xl font-medium shadow-lg shadow-purple-900/20 border border-white/10"
                  >
            ...
            <motion.div variants={fadeIn} className="relative mx-auto lg:mx-0 max-w-xl w-full">
              <div className="relative">
                <div className="absolute -inset-1 bg-gradient-to-br from-purple-300 to-purple-600 rounded-2xl blur-md opacity-70"></div>
                <div className="relative bg-gradient-to-br from-purple-100 to-purple-50 rounded-2xl p-1">
                  <img
                    src={webinar.thumbnail || "/placeholder.svg"}
                    alt="Microsoft Dynamics Webinar"
                    width={500}
                    height={400}
                ...
                <div className="absolute -top-6 right-0 sm:-right-6">
                  ...
                  >
                    <div className="flex items-center space-x-2">
                      ...
                      <p className="text-sm font-medium text-gray-600">4.5/5 rating</p>
                    </div>
                  </motion.div>
                </div>
              </div>
        ...
        <div className="absolute bottom-0 left-0 right-0 h-24 bg-gradient-to-t from-purple-50/50 to-transparent"></div>
      ...
      <section id="about" className="py-5 md:py-10">
        <div className="container mx-auto px-4">
          ...
          >
            <div className="inline-flex items-center justify-center gap-2 bg-purple-100 text-purple-800 rounded-full px-4 py-1.5 text-sm font-medium mb-4">
            ...
            <p className="text-lg text-gray-700 leading-relaxed">
              This comprehensive master class will take you through the powerful features and capabilities of Microsoft
              Dynamics 365. Learn how to leverage this platform to streamline operations, enhance customer
            ...
            {[
              {
                ...
                description:
                  "Master the suite of business applications including Sales, Customer Service, Marketing, and Field Service.",
              },
              {
                title: "Integration & Customization",
                description:
                  "Learn how to integrate Dynamics 365 with other Microsoft tools and customize it for your specific needs.",
              },
              {
                title: "Data Analytics",
                description:
                  "Harness the power of data analytics and AI capabilities to gain actionable business insights.",
              },
            ].map((feature, index) => (
              <motion.div
                key={index}
                ...
                className="bg-white rounded-2xl p-8 shadow-xl shadow-purple-100/50 border border-purple-100/50"
              >
      ...
      {/* Speakers Section */}
      <section id="speakers" className="py-10 bg-gradient-to-b from-white to-purple-50/50">
        <div className="container mx-auto px-4">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <p className="text-lg text-gray-700 max-w-2xl mx-auto">
              Learn from certified Microsoft Dynamics 365 experts with years of implementation and training experience.
            </p>
          </motion.div>
          ...
          <div className="flex justify-center">
                ...
                >
                    <div className="bg-white rounded-2xl overflow-hidden shadow-xl shadow-purple-100/50 border border-purple-100/50 transition-all duration-300 group-hover:-translate-y-2 flex flex-col md:flex-row">
                    {/* Image Section */}
                    <div className="md:w-1/2">
                        <div className="h-64 md:h-full bg-gradient-to-br from-purple-400 to-purple-600 relative overflow-hidden">
                        ...
                        <div className="absolute bottom-0 left-0 right-0 p-6 z-20 md:hidden">
                            ...
                            <p className="text-purple-200">{webinar.presenterRole}</p>
                        </div>
                        </div>
                    </div>
                    ...
                    <div className="md:w-1/2 p-6 md:flex-col items-center justify-center">
                        ...
                        <p className="text-gray-700">{webinar.presenterName + " "}has implemented Dynamics 365 solutions for over 50 enterprise clients and is a Microsoft Certified Trainer.</p>
                    </div>
                    </div>
                </motion.div>
            </div>
      ...
      <section id="agenda" className="py-10 bg-white">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg text-gray-700 max-w-2xl mx-auto">
              A comprehensive curriculum designed to help you master Microsoft Dynamics 365.
            </p>
          </motion.div>
      ...
      <section id="register" className="py-10 bg-gradient-to-br from-purple-50 to-purple-100/50">
        <div className="container mx-auto px-4">
            ...
            <div className="bg-white rounded-3xl overflow-hidden shadow-2xl">
              <div className="grid md:grid-cols-2">
                <motion.div
                  ...
                  viewport={{ once: true }}
                  transition={{ duration: 0.6 }}
                  className="p-8 md:p-12 bg-gradient-to-br from-purple-600 to-purple-500 text-white"
                >
                  <h2 className="text-3xl font-bold mb-6">Reserve Your Spot Today</h2>
                  <p className="text-lg text-white/90 mb-8 leading-relaxed">
                    Don't miss this opportunity to master Microsoft Dynamics 365. Registration is free, but spots are
                    limited.
                  </p>
                    ...
                    <div>
                      ...
                      <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                          <Button
                            type="submit"
                            className="w-full bg-gradient-to-r from-purple-600 to-purple-500 hover:from-purple-700 hover:to-purple-600 text-white py-6 rounded-xl font-medium text-lg shadow-lg shadow-purple-200"
                          >
      ...
      {/* CTA Section */}
      <section className="py-10 bg-gradient-to-r from-purple-600 to-purple-500 text-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <motion.div
              ...
              transition={{ duration: 0.6 }}
            >
              <h2 className="text-3xl md:text-4xl font-bold mb-6">Ready to Master Microsoft Dynamics 365?</h2>
              <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
                Join 1,000+ professionals who have already secured their spot for this exclusive master class.
              </p>
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.98 }} className="inline-block">
                <Button
                  size="lg"
                  className="bg-white text-purple-600 hover:bg-gray-100 rounded-xl font-medium shadow-lg shadow-purple-900/20 border border-white/10 px-8 py-6 text-lg"
                >
                  <a href="#register" className="flex items-center gap-2">
...
export default MicrosoftDynamicsWebinar
